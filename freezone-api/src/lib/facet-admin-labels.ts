...
export const FACET_ADMIN_LABEL_AR: Record<string, string> = {
  ...
  // —— Tablets / iPad ——
  biometricAuth: "القفل الحيوي (Face ID / Touch ID / بصمة…)",
  bluetoothVersion: "إصدار Bluetooth (مثال 5.3)",
  cameraFront: "كاميرا أمامية / TrueDepth / Center Stage",
  cameraRear: "كاميرا خلفية (مثال 12MP + 10MP)",
  cellularNetwork: "شبكة خلوية (Wi‑Fi فقط / Wi‑Fi + Cellular / 5G / eSIM)",
  chargingPowerW: "شحن سريع (قدرة المحول بالواط، مثال 20W / 30W)",
  connectorType: "منفذ الشحن والبيانات (USB‑C / Lightning / Thunderbolt / USB 4)",
  displayFeatures: "ميزات الشاشة (سطوع شموس، True Tone، ProMotion، nano‑texture…)",
  keyboardAccessory: "لوحة مفاتيح اختيارية (Magic Keyboard، غطاء لوحة…)",
  stylusSupport: "قلم ذكي (Apple Pencil / S Pen / لا يوجد)",
  batteryCapacityMah: "سعة البطارية (مللي أمبير ساعة mAh)",
  speakerConfig: "مكبرات الصوت (ستيريو، رباعي…)",
...
/** English facet labels — aligned with storefront `Products.*` keys. */
...
export const FACET_UI_GROUPS: FacetUiGroup[] = [
  ...
  {
    id: "tablet",
    titleAr: "تابلت وآيباد",
    titleEn: "Tablets & iPad",
    keys: [
      "model",
      "cpu",
      "gpu",
