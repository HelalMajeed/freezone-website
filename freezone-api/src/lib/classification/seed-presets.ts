...
export const CLASSIFICATION_SEED_BY_SLUG: Record<string, FacetAttributeDef[]> = {
  ...
  laptops: [
    flt({ key: "brand", name_en: "Brand", name_ar: "الماركة", type: "SELECT", searchable: true, displayGroup: "identity" }),
    flt({ key: "processor_family", name_en: "Processor family", name_ar: "عائلة المعالج", type: "SELECT", displayGroup: "performance", options: ["Core i3", "Core i5", "Core i7", "Core i9", "Ryzen 5", "Ryzen 7", "Ryzen 9", "Ultra 7", "Ultra 9", "Apple M1", "Apple M2", "Apple M3"] }),
    ...
    flt({ key: "gpu_model", name_en: "GPU model", name_ar: "موديل كرت الشاشة", type: "SELECT", displayGroup: "performance" }),
    flt({ key: "screen_size", name_en: "Screen size", name_ar: "حجم الشاشة", type: "RANGE", unit: "inch", displayGroup: "display" }),
    flt({ key: "refresh_rate", name_en: "Refresh rate", name_ar: "معدل التحديث", type: "RANGE", unit: "Hz", displayGroup: "display" }),
    ...
    ext({ key: "ram_type", name_en: "RAM type", name_ar: "نوع الرام", type: "SELECT", displayGroup: "performance", options: ["DDR4", "DDR5", "LPDDR5"] }),
    ext({ key: "storage_display", name_en: "Storage", name_ar: "التخزين (نص كامل)", type: "TEXT", displayGroup: "performance" }),
    ext({ key: "storage_interface", name_en: "Storage interface", name_ar: "واجهة التخزين", type: "SELECT", displayGroup: "performance", options: ["NVMe", "SATA", "PCIe"] }),
