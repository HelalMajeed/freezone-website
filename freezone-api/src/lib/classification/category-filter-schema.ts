...
export const CATEGORY_SCHEMA_SLUG_ALIASES: Record<string, string> = {
  ...
  smartphones: "phones",
  smartphone: "phones",
  "power-charging": "power-solutions",
  "power-charging-accessories": "power-solutions",
  security: "security",
  electric: "electric",
  hardware: "hardware",
  gaming: "gaming",
  // Child categories (Category.parentId tree) → closest preset schema.
  "ip-cameras": "cctv",
  "wifi-cameras": "cctv",
  "dvr-nvr": "cctv",
  "alarm-systems": "security",
  "fingerprint-attendance": "security",
  "smart-locks": "security",
  intercom: "security",
  "business-laptops": "laptops",
  "gaming-laptops": "laptops",
  "everyday-laptops": "laptops",
  "desktops-builds": "computers",
  consoles: "gaming",
  controllers: "gaming",
  ...
  switches: "networking",
  "cables-tools": "networking",
  "smart-lighting": "smart-home",
  "plugs-switches": "smart-home",
  sensors: "smart-home",
  "smart-hubs": "smart-home",
  ups: "power-solutions",
  inverters: "power-solutions",
  "lithium-batteries": "power-solutions",
  "solar-systems": "power-solutions",
  converters: "power-solutions",
};
...
export const CLASSIFICATION_SEED_BY_SLUG: Record<string, FacetAttributeDef[]> = {
  ...
  phones: [
    ...
    flt({
      key: "main_camera_mp",
      name_en: "Main camera",
      name_ar: "الكاميرا الرئيسية",
      type: "SELECT",
      options: ["12", "48", "50", "64", "108", "200"],
      displaySpecKey: "camera_full",
      displaySpecNameEn: "Camera (full)",
      displaySpecNameAr: "الكاميرا (نص كامل)",
      linkDisplaySpec: true,
  ...
  "power-solutions": [
    brandFilter(),
    productTypeFilter(["Charger", "Power bank", "GaN charger", "Cable", "Adapter"]),
    flt({
      key: "wattage",
      name_en: "Wattage",
      name_ar: "القدرة",
      type: "RANGE",
      unit: "W",
      displaySpecKey: "charging_full",
      displaySpecNameEn: "Charging (full)",
      displaySpecNameAr: "الشحن (نص كامل)",
      linkDisplaySpec: true,
      displayGroup: "battery",
    }),
    flt({
      key: "ports",
      name_en: "Ports",
    ...
    flt({
      ...
      name_ar: "نوع الموصل",
      type: "SELECT",
      options: ["USB-C", "Lightning", "Micro-USB", "MagSafe"],
      displaySpecKey: "charging_full",
      linkDisplaySpec: true,
    }),
    flt({ key: "fast_charging", name_en: "Fast charging", name_ar: "شحن سريع", type: "BOOLEAN" }),
    flt({ key: "gan", name_en: "GaN", name_ar: "GaN", type: "BOOLEAN" }),
