...
export function getOfflineCmsPayload() {
  const siteConfig = {
    ...
    metaDescriptionEn:
      "Iraq's leading electronics store: CCTV & security, computers & laptops, gaming PCs, components, AI & robots, power & UPS, smart home & cities, servers & networking, data solutions. B2B deals. PC builder. 2-year warranty. Programming & professional services." as string | null,
    metaDescriptionAr:
      "متجر إلكترونيات رائد في العراق: أنظمة المراقبة والكاميرات، الحواسيب واللابتوبات، أجهزة الألعاب والمكوّنات، الذكاء الاصطناعي والروبوتات، الطاقة والUPS، المنزل والمدن الذكية، الخوادم والشبكات وحلول البيانات. عروض للشركات. مُجمّع أجهزة. ضمان سنتين. حلول برمجية." as string | null,
