import type { StorefrontValue } from "@/components/providers/StorefrontProvider";
...
export type AdminCmsDraft = {
  siteConfig: {
    ...
    /** Hex chevron color for hero prev/next (with heroNavArrowOpacityPct → rgba) */
    heroNavArrowColor?: string | null;
    /** 0–100: chevron opacity */
    heroNavArrowOpacityPct?: number | null;
    /** Hex fill behind hero arrows (with heroNavBoxOpacityPct → rgba) */
    heroNavBoxColor?: string | null;
    /** 0–100: arrow button background opacity */
    heroNavBoxOpacityPct?: number | null;
    /** Hex base color for trust bar under hero (default #030712) */
    trustBarBgColor?: string | null;
    /** 0–100: opacity of trust bar background */
